...
<aside class="sidebar" id="appSidebar">
  ...
  <div class="sidebar-user">
    <div class="user-popup" id="userPopup">
      ...
      <hr>
      <a href="<?= e(base_url('logout.php')) ?>" class="text-danger" onclick="return confirm('Yakin ingin logout?');"><i class="bi bi-box-arrow-right"></i> Logout</a>
    </div>
